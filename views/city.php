                                ...
                                <table class="table table-striped table-bordered zero-configuration">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($city as $row) :
                                            ...
                                            $data_state = $this->Crud_model->fetch('state', array('id' => $row->state_id));
                                        ?>
                                            <tr>
                                                <td><?php echo $i++; ?></td>
                                                <td><?php echo $data_country->row('country_name'); ?></td>
                                                <td><?php echo $data_state->row('state_name'); ?></td>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <h5 class="text-center pt-4">City</h5>
                <div class="modal-body">
                    <form class="form" method="post" id="form">
                        ...
                        <div class="form-group pt-2">
                            <label>City Name : <span class="star">★</span></label>
                            <input type="text" name="city_name" placeholder="Enter The Name" class="form-control" style="padding: 15px 12px;" required />
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" method="post" id="form">
                        ...
                        <div class="form-group pt-2">
                            <label>City Name : <span class="star">★</span></label>
                            <input type="text" name="city_name" id="state_name" placeholder="Enter The Name" class="form-control" style="padding: 15px 12px;" required />
                        </div>
                        <div class="form-group">
